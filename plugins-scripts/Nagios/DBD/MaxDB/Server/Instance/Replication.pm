package DBD::MaxDB::Server::Instance::Replication;
...
sub init {
  ...
  if ($params{mode} =~ /server::instance::replication/) {
    $self->{internals} =
        DBD::MaxDB::Server::Instance::Replication::Internals->new(%params);
  }
}
...
package DBD::MaxDB::Server::Instance::Replication::Internals;

use strict;

our @ISA = qw(DBD::MaxDB::Server::Instance::Replication);
