package DBD::MaxDB::Server::Instance::Innodb;

use strict;

our @ISA = qw(DBD::MaxDB::Server::Instance);
...
sub init {
  ...
  if ($params{mode} =~ /server::instance::innodb/) {
    $self->{internals} =
        DBD::MaxDB::Server::Instance::Innodb::Internals->new(%params);
  }
}
...
package DBD::MaxDB::Server::Instance::Innodb::Internals;

use strict;

our @ISA = qw(DBD::MaxDB::Server::Instance::Innodb);
