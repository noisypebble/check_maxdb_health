package DBD::MaxDB::Server::Instance::MyISAM;
...
sub init {
  ...
  if ($params{mode} =~ /server::instance::myisam/) {
    $self->{internals} =
        DBD::MaxDB::Server::Instance::MyISAM::Internals->new(%params);
  }
}
...
package DBD::MaxDB::Server::Instance::MyISAM::Internals;

use strict;

our @ISA = qw(DBD::MaxDB::Server::Instance::MyISAM);
